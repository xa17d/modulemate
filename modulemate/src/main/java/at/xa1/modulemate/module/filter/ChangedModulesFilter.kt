...
fun Collection<Module>.findModuleByFile(fileRelativePath: String): Module? =
    this
...
fun Collection<Module>.findModulesByFiles(filesRelativePath: List<String>): List<Module> =
    filesRelativePath
